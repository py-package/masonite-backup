...
1. Fork the `https://github.com/py-package/masonite-backup` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/backup.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall backup && pip install .`
